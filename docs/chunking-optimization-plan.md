...
- `src/main/java/com/yizhaoqi/starmind/service/ParseService.java`
- `src/main/java/com/yizhaoqi/starmind/repository/DocumentVectorRepository.java`
- `src/main/java/com/yizhaoqi/starmind/service/VectorizationService.java`
- `src/main/resources/application*.yml`
- `src/test/java/com/yizhaoqi/starmind/service/*ParseService*Test.java`
...
```text
src/main/java/com/yizhaoqi/starmind/service/chunk/
