...
import com.yizhaoqi.starmind.service.RechargeService;
import com.yizhaoqi.starmind.service.WxPayService;
...
public class RechargeController {
    ...
    public ResponseEntity<?> getPackages() {
        try {
            List<com.yizhaoqi.starmind.model.RechargePackage> packages = rechargeService.getAllPackages();
