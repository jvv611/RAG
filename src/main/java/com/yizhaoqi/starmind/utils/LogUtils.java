package com.yizhaoqi.starmind.utils;
...
public class LogUtils {
    ...
    // 业务日志记录器
    private static final Logger BUSINESS_LOGGER = LoggerFactory.getLogger("com.yizhaoqi.starmind.business");
    
    // 性能日志记录器
    private static final Logger PERFORMANCE_LOGGER = LoggerFactory.getLogger("com.yizhaoqi.starmind.performance");
