...
import com.yizhaoqi.starmind.model.RechargeOrder;
import com.yizhaoqi.starmind.model.RechargeOrder.OrderStatus;
import com.yizhaoqi.starmind.model.RechargePackage;
import com.yizhaoqi.starmind.repository.RechargeOrderRepository;
import com.yizhaoqi.starmind.repository.RechargePackageRepository;
import com.yizhaoqi.starmind.utils.PriceUtil;
...
public class RechargeService {
    ...
    public WxPayService.PrePayInfoResBo createRechargeOrder(
        ...
        if (packageId != null && packageId > 0) {
            ...
            description = "【星识】充值套餐：" + rechargePackage.getPackageName();
        } else {
            // 自定义充值
            ...
            description = "【星识】自定义充值￥" + PriceUtil.toYuanPrice(amount) + "元";
        }
