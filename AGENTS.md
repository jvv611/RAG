...
This file is the agent-facing working agreement for the `StarMind` repository.

## Purpose

StarMind (星识) is an enterprise AI knowledge management system built around a RAG workflow:
...
StarMind uses organization tags and user/org relationships.
